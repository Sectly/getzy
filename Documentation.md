...
2. [Extended Overview](#extended-overview)
3. [Architecture and Design Details](#architecture-and-design-details)
   - [Internal Workflow](#internal-workflow)
   - [Middleware Phases](#middleware-phases)
4. [Deep Dive into API & Request Options](#deep-dive-into-api--request-options)
   - [HTTP Methods and Their Nuances](#http-methods-and-their-nuances)
   - [Advanced Request Options](#advanced-request-options)
5. [In-Depth Middleware & Integrations](#in-depth-middleware--integrations)
   - [Before vs. After Middleware](#before-vs-after-middleware)
   - [Global Error Handling](#global-error-handling)
6. [Additional Code Examples & Use Cases](#additional-code-examples--use-cases)
...
7. [CLI Extended Documentation](#cli-extended-documentation)
   - [Advanced CLI Options](#advanced-cli-options)
   - [Complex CLI Scenarios](#complex-cli-scenarios)
8. [Do's and Don'ts](#dos-and-donts)
9. [Requirements and Limitations](#requirements-and-limitations)
